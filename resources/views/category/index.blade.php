...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-primary"
                        onclick="window.location='{{ url('category/add') }}'">
    ...
    <script>
        function deleteData(name) {
            pesan = confirm(`yakin data data category dengan nama ${name} ini dihapus ?`);
